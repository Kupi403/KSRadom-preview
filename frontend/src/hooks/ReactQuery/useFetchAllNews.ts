...
// const fetchNews = async ({ order = 'desc', currentPage, postsPerPage, category }: NewsSortOption) => {
// 	//QUERY Z CREATEDBY
...
export default function useFetchAllNews(params: Parameters<typeof fetchNews>[0]) {
	return useQuery({
