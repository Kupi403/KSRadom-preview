...
const CourseInfo = () => {
	...
	const date = courseInfo?.dueDate ? getLocaleDate(new Date(courseInfo?.dueDate), DateFormat.FULL_DATE) : ''
	...
	return (
		<div className={styles['course-info']}>
			...
			<div className={styles.form}>
				<h2 className={styles.subtitle}>Zapisz się na kurs sędziowski</h2>
				<CourseForm />
			</div>
		</div>
	)
